...
**Solution:** [0-print_list.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x12-singly_linked_lists/0-print_list.c)
```
...
**Solution:** [1-list_len.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x12-singly_linked_lists/1-list_len.c)
```
...
**Solution:** [2-add_node.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x12-singly_linked_lists/2-add_node.c)
```
...
**Solution:** [3-add_node_end.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x12-singly_linked_lists/3-add_node_end.c)
```
...
**Solution:** [4-free_list.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x12-singly_linked_lists/4-free_list.c)
```
