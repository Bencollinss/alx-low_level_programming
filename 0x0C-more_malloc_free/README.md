...
**Solution:** [0-malloc_checked.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x0C-more_malloc_free/0-malloc_checked.c)
```
...
**Solution:** [1-string_nconcat.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x0C-more_malloc_free/1-string_nconcat.c)
```
...
**Solution:** [2-calloc.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x0C-more_malloc_free/2-calloc.c)
```
...
**Solution:** [3-array_range.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x0C-more_malloc_free/3-array_range.c)
```
Write a function that creates an array of integers.
...
**Solution:** [100-realloc.c](https://github.com/Bencollinss/alx-low_level_programming/blob/master/0x0C-more_malloc_free/100-realloc.c)
```
